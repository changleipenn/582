...
with engine.connect() as con:
    order_dict = make_order( platforms[random.randint(0,1)] )
    statement = text("""INSERT INTO orders(buy_currency, sell_currency, buy_amount,sell_amount,sender_pk,receiver_pk) VALUES(:buy_currency, :sell_currency, :buy_amount,:sell_amount,:sender_pk,:receiver_pk)""")
    con.execute(statement, **order_dict)
